...
//    bool isMarkerAtPosition(timeT time) const;
    ...
    void setLoopRange(const timeT &lS, const timeT &lE) {
    ...
    bool loopRangeIsActive() const { return m_loopRangeIsActive; }
    LoopingMode loopingMode() const { return m_loopingMode; }
