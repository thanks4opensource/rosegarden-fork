...
private:
    ...
    // Used to populate m_segments in constructor without explicit list
    //   of segments (used by TrackEditor / main window) as opposed
    //   to constructor with (used by MatrixWidget and NotationWidget)
    Studio      *m_studio;
