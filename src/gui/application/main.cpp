...
int main(int argc, char *argv[])
{
    ...
    if (newVersion) {
        ...
        label->setText(QObject::tr(
         "<h2>Welcome to Rosegarden!</h2>"
         "<p>Welcome to the Rosegarden audio and MIDI sequencer and "
         "musical notation editor.</p>"
         "<ul><li>If you have not already done so, you may wish to "
         "install some DSSI synth plugins, or a separate synth program "
         "such as QSynth.  Rosegarden does not synthesize sounds from "
         "MIDI on its own, so without these you will hear nothing.</li>"
         "<li>Rosegarden uses the JACK audio server for recording and "
         "playback of audio, and for playback from DSSI synth plugins.  "
         "These features will only be available if the JACK server is "
         "running.</li>"
         "<li>Rosegarden has comprehensive documentation: see the "
         "<a style=\"color:gold\""
         "href=\"http://rosegardenmusic.com\">Rosegarden website</a>"
         "for the <a style=\"color:gold\""
         "href=\"%1\">manual</a>, "
         "<a style=\"color:gold\""
         "href=\"http://www.rosegardenmusic.com/tutorials/\">tutorials</a>, "
         "and other information!"
         "</li>"
         "</ul><p>Rosegarden was brought to you by a team of volunteers "
         "across the world.  To learn more, go to the "
         "<a style=\"color:gold\""
         "href=\"http://www.rosegardenmusic.com/\">Rosegarden website</a>."
         "</p>"
         "</ul><p>You are currently using the \"thanks4opensource\" fork "
